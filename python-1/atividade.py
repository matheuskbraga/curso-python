...
inicio = time.time_ns()
# COLOQUE UMA FRASE PARA A VARIÁVEL 'FRASE' PARA A FUNÇAÕ SER ACIONADA
frase = '''Um retrato das mulheres na pesquisa
...
print("Contagem de caracteres na frase:", resultado)
print("Tempo de execução:", "{}".format(tempo_execucao/1000000000), "segundos")